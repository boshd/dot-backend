...
| OpenAI | Review dashboard | Set a dedicated Dot project alert and hard limit before external beta | Active |
...
| Domain | $0 | Record annual price when purchased | Not purchased |
...
| --- | --- | --- | --- |
| Railway | Hobby is at least $5/month including $5 usage; then metered RAM, CPU, egress, and volume | One replica per service, private networking, $10 soft/$20 hard workspace limit | [Pricing](https://docs.railway.com/pricing/plans), [cost controls](https://docs.railway.com/pricing/cost-control) |
...
| OpenAI | Terra: $2/M input and $12/M output tokens. Luna: $0.20/M input and $1.20/M output. Embeddings: $0.02/M tokens. Web search: $0.01/call plus tokens | Dedicated project limits; low reasoning for normal work; bounded context/tool rounds and search sources | [Pricing](https://developers.openai.com/api/docs/pricing), [spend limits](https://developers.openai.com/api/docs/guides/spend-limits) |

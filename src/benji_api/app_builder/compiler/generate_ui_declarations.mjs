...
const sdkPath = fileURLToPath(new URL("./sdk/ui.tsx", import.meta.url));
const tempDirectory = await mkdtemp(join(tmpdir(), "dot-ui-types-"));
...
try {
  ...
  if (diagnostics.length) {
    ...
    process.stdout.write(await readFile(join(tempDirectory, "ui.d.ts"), "utf8"));
  }
} finally {
